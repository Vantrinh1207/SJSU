...
class SJSU_Student extends SJSU_Academic {
    ...
    // Students can swap courses between cs152 and cs153 as if it changes the outcome
    void swapCourse() {
...
class SJSU_Professor extends SJSU_Academic {
    ...
    // Professors cheer with their course number.
    String cheer() {
        return "Go! " ;
    }
}
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; ++i) {
            ...
            if (input.equals("miss")) {
                // It's a miss, students change their favorite course thinking it changes the outcome.
                for (SJSU_Student student : students) {
                    student.swapCourse();
                }
            } else { // it's a score!
                // Professors and students cheer.
